...
procedure exercise8 is
    ...
    protected body Transaction_Manager is
        ...
        begin
            ...
            if Wait_Until_Aborted'Count = 0 then
                --Put_Line("Everybody has aborted");
                Aborted := False;
            end if;
        ...
        begin
            ...
            if Finished'Count = N-1 then
                ...
                --Put_Line("Everybody is finished");
    ...
    begin
        if MyInt >= Error_Rate then
            delay Duration(5);
            return x+10;
        else
            Put_Line("Count Error!");
            delay Duration(0.5);
            raise Count_Failed;
        end if;
    ...
    begin
        ...
        loop
            ...
            select
                ...
                Num := Prev +5;
                Put_Line("  Error : Worker" & Integer'Image(Initial) & " comitting" & Integer'Image(Num));
